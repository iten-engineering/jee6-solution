...
import ch.itenengineering.cc.ejb.CurrencyConverterRemote2;
...
public class CurrencyConverterClient2 {
	...
	public void convert() throws NamingException {
		...
		CurrencyConverterRemote2 currencyConverter = (CurrencyConverterRemote2) ctx
				.lookup("ejb:/CurrencyConverterWithNoIterfaceView/CurrencyConverterBean2!ch.itenengineering.cc.ejb.CurrencyConverterRemote2");
	...
	public static void main(String[] args) {
		...
		try {
			// run the application
			new CurrencyConverterClient2().convert();
